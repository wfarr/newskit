...
namespace Summa {
    public class FeedPropertiesDialog : Gtk.Window {
        public Summa.Browser browser;
        public NewsKit.Feed feed;
        ...
        public FeedPropertiesDialog(Summa.Browser browse, NewsKit.Feed f) : base(Gtk.WindowType.Toplevel) {
            browser = browse;
            feed = f;
        ...
        private void AddTagsTab() {
            ...
            foreach ( string tag in NewsKit.Daemon.GetTags() ) {
        ...
        private void OnAddButtonClicked(object obj, EventArgs args) {
            Window win = new Summa.AddTagDialog(this);
            win.ShowAll();
        }
